...
import com.example.Homework.service.InstructorService;
...
public class HomeworkApplication {
    ...
    @Bean
    CommandLineRunner run(StudentService studentService, InstructorService instructorService, PackService packService, CourseService courseService, CourseRepository courseRepository) {
        return args ->  {
